...
<title>Daftar | Bendahara - MONET</title>
    ...
    <div class="hidden lg:flex lg:w-7/12 relative overflow-hidden bg-primary items-center justify-center">
        <div class="relative z-10 px-16 max-w-2xl">
            ...
            <p class="text-xl text-primary-fixed-dim leading-relaxed">
                Buat akun untuk mengakses dashboard bendahara.
            </p>
        </div>
    ...
    <div class="w-full lg:w-5/12 flex flex-col justify-center bg-surface px-8 md:px-16 lg:px-24 overflow-y-auto">
        <div class="max-w-md w-full mx-auto py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-on-surface-variant">Isi data di bawah ini untuk membuat akun bendahara.</p>
            </div>
            ...
            <form method="POST" action="/bendahara/register" class="space-y-4">
                @csrf
                ...
                <button id="btn-register-bendahara" type="submit"
